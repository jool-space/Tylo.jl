...
julia --project=test/gpu test/gpu/snapshot.jl /path/to/evidence
cp /path/to/evidence/manifest.toml test/gpu/snapshots/<date>-<device>-tylo.toml
```
...
```sh
TYLO_SNAPSHOT=$PWD/test/gpu/snapshots/2026-09-14-gb10-tylo.toml \
